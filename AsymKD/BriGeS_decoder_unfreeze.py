...
class AsymKD_DPTHead(nn.Module):
    ...
    def unfreeze_BriGeS_decoder(self):
...
class BriGeS_decoder_unfreeze(nn.Module):
    ...
    def freeze_BriGeS_unfreeze_deocder_style(self):
        ...
        self.depth_head.unfreeze_BriGeS_decoder()
