...
from torchhub.facebookresearch_dinov2_main.dinov2.layers.block import Grouped_Block
from torchhub.facebookresearch_dinov2_main.dinov2.layers.mlp import Mlp, Mlp_lora, Grouped_Mlp
...
class kd_naive_depth_latent4_grouped_attn_adapter(nn.Module):
    def __init__(self, encoder='vitb', features=128, out_channels=[96, 192, 384, 768], use_bn=False, use_clstoken=False, localhub=True):
        super(kd_naive_depth_latent4_grouped_attn_adapter, self).__init__()
        
        print('kd_naive_depth_latent4_grouped_attn_adapter')
    ...
    def freeze_kd_naive_dpt_latent4_grouped_attn_adapter_with_kd_style(self):
